    ...
    <div className="app-layout">
      <aside className="app-sidebar">
        ...
        <div className="app-sidebar-version" role="button" tabIndex="0"
          ...
          title="กดเพื่อดูประวัติการแก้ไข · อัปเดตล่าสุด 16 กันยายน 2569 เวลา 08:57 น. (เวลาไทย)"
          onClick={() => setVersionHistoryOpen(true)}
          onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setVersionHistoryOpen(true); } }}>
          <div className="app-version-number">v1.3.10 · ดูประวัติ</div>
          <div className="app-version-updated">
            <span className="app-version-dot"></span>
            <span>อัปเดตล่าสุด</span>
          </div>
          <time dateTime="2026-09-16T08:57:00+07:00">16 ก.ย. 2569 · 08:57 น.</time>
        </div>
      </aside>
