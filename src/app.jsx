  ...
  return (
    <div className="app-layout">
      <aside className="app-sidebar">
        ...
        <div className="app-sidebar-version" title="อัปเดตล่าสุด 1 กันยายน 2569 เวลา 08:49 น. (เวลาไทย)">
          <div className="app-version-number">v1.0.7</div>
          <div className="app-version-updated">
            <span className="app-version-dot"></span>
            <span>อัปเดตล่าสุด</span>
          </div>
          <time dateTime="2026-09-01T08:49:00+07:00">1 ก.ย. 2569 · 08:49 น.</time>
        </div>
      </aside>
